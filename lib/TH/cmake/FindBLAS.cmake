...
IF (NOT BLAS_FOUND AND BLAS_FIND_REQUIRED)
  ...
  ELSE(NOT PURE_BLAS_FOUND)
    message(WARNING "BLAS API is MKLML. It is a deficient BLAS package, LAPACK is excluded. You'd better specify a library location.")
...
IF(NOT BLAS_FIND_QUIETLY)
  IF(BLAS_FOUND OR PURE_BLAS_FOUND)
    ...
    ENDIF(BLAS_FOUND)
    IF(PURE_BLAS_FOUND)
      MESSAGE(STATUS "Found a library with BLAS API (mklml). It is preferd to use these BLAS API if possible")
